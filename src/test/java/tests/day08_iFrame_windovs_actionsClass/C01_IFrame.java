...
public class C01_IFrame extends TestBase {
    ...
    public void test01(){
         ...
         */
        WebElement iFrameElementi = driver.findElement(By.id("mce_0_ifr")); //Web element ile iframeye gitmek için
        driver.switchTo().frame(0); // web elementle yapıldı
       // driver.switchTo().frame("mce_0_ifr"); --> id ile de olur
       // driver.switchTo().frame(0);           --> index ile de olur
        ...
        /*
            Bir iFrame gecis yapildiysa normal sayfada islem yapilamaz normal sayfada islem yapmak isterseniz
         ...
         */
        driver.switchTo().defaultContent(); // İFrameden tekrar ana sayfaya geçiyoruz
